...
object WidgetPreferences {
    ...
    fun getJournalistColor(c: Context): Int = prefs(c).getInt("journalist_bg_color", 0xFFFF5252.toInt())
    fun setJournalistColor(c: Context, color: Int) = prefs(c).edit { putInt("journalist_bg_color", color) }
}
