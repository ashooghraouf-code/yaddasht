        ...
        fun updateAppWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
            CoroutineScope(Dispatchers.IO).launch {
                ...
                if (notes.isNotEmpty()) {
                    ...
                    views.setTextViewText(R.id.note_body_1, n1?.body?.take(80) ?: "")
                    views.setViewVisibility(R.id.note_item_1, View.VISIBLE)

                    val n2 = notes.getOrNull(1)
                    if (n2 != null) {
                        views.setTextViewText(R.id.note_title_2, n2.title)
                        views.setTextViewText(R.id.note_body_2, n2.body.take(80))
                    ...
                    if (n3 != null) {
                        ...
                        views.setTextViewText(R.id.note_body_3, n3.body.take(80))
                        views.setViewVisibility(R.id.note_item_3, View.VISIBLE)
                    } else {
                        views.setViewVisibility(R.id.note_item_3, View.GONE)
                    }
                } else {
                    views.setTextViewText(R.id.note_title_1, "یادداشتی نیست")
                    views.setViewVisibility(R.id.note_item_2, View.GONE)
                    views.setViewVisibility(R.id.note_item_3, View.GONE)
                }
